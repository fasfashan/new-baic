    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute bottom-36 left-1/2 transform -translate-x-1/2 z-30">
        <a
          ...
          className="inline-block text-nowrap text-center border-2 border-white text-white font-medium px-8 py-3 rounded-xl text-lg hover:bg-black hover:border-black transition-colors"
        >
